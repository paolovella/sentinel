...
(*                                                                        *)
(* MaxDepth=2 so a full chain (depth 2->1->0) needs 3 tokens.             *)
(* DL1 liveness is guarded by token capacity: chains either reach         *)
(* depth 0 or the bounded model exhausts its token slots.                 *)
(*                                                                        *)
