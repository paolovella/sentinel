...
| A2A Agent Card signature verification | `vellaveto-mcp/src/a2a/signature.rs` |
| A2A Agent Card ingestion (fetch → verify → cache) | `vellaveto-mcp/src/a2a/fetch.rs` |
| A2A listener (the enforcement path) | `vellaveto-http-proxy/src/a2a_listener.rs` |
