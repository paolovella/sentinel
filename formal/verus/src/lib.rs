...
#[path = "../verified_capability_delegation_context.rs"]
...
mod verified_capability_identity;
#[path = "../verified_capability_literal.rs"]
mod verified_capability_literal;
#[path = "../verified_capability_path.rs"]
mod verified_capability_path;
