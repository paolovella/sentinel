...
pub struct SessionState {
    ...
    /// Opaque approval/audit scope binding for this session.
    ///
    /// This is generated by the proxy and intentionally independent from the
    /// transport-facing `session_id`.
...
impl SessionState {
    pub fn new(session_id: String) -> Self {
        ...
        Self {
            session_id,
            session_scope_binding: generate_session_scope_binding(),
            created_at: now,
            last_activity: now,
...
fn generate_session_scope_binding() -> String {
    format!("sidbind:v1:{}", uuid::Uuid::new_v4().simple())
}
